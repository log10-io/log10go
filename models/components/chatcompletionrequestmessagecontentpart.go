...
type ChatCompletionRequestMessageContentPart struct {
	ChatCompletionRequestMessageContentPartText  *ChatCompletionRequestMessageContentPartText  `queryParam:"inline"`
	ChatCompletionRequestMessageContentPartImage *ChatCompletionRequestMessageContentPartImage `queryParam:"inline"`
