...
type ChatCompletionRequestMessage struct {
	ChatCompletionRequestSystemMessage    *ChatCompletionRequestSystemMessage    `queryParam:"inline"`
	ChatCompletionRequestUserMessage      *ChatCompletionRequestUserMessage      `queryParam:"inline"`
	ChatCompletionRequestAssistantMessage *ChatCompletionRequestAssistantMessage `queryParam:"inline"`
	ChatCompletionRequestToolMessage      *ChatCompletionRequestToolMessage      `queryParam:"inline"`
	ChatCompletionRequestFunctionMessage  *ChatCompletionRequestFunctionMessage  `queryParam:"inline"`
