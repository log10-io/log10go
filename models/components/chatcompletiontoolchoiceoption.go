...
type ChatCompletionToolChoiceOption struct {
	ChatCompletionToolChoiceOption1 *ChatCompletionToolChoiceOption1 `queryParam:"inline"`
	ChatCompletionNamedToolChoice   *ChatCompletionNamedToolChoice   `queryParam:"inline"`
