...
// Create a session
func (s *Sessions) Create(ctx context.Context, xLog10Organization *string, opts ...operations.Option) (*operations.CreateSessionResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/sessions")
	if err != nil {
